...
import 'create_new_order_page_model.dart';
export 'create_new_order_page_model.dart';

class CreateNewOrderPageWidget extends StatefulWidget {
  const CreateNewOrderPageWidget({super.key});

  @override
  State<CreateNewOrderPageWidget> createState() =>
      _CreateNewOrderPageWidgetState();
}

class _CreateNewOrderPageWidgetState extends State<CreateNewOrderPageWidget> {
  late CreateNewOrderPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateNewOrderPageModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(10.0, 35.0, 10.0, 0.0),
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Row(
...
(до 10 штук) */
                              ...
                              if (_model.uploadedFileUrls1.isNotEmpty)
                                Builder(
                                  builder: (context) {
                                    final photoList = _model.uploadedFileUrls1
                                        .map((e) => e)
                                        .toList()
                                        .take(10)
                                        .toList();
                      ...
                      TextFormField(
                        ...
                        keyboardType: TextInputType.number,
                        validator: _model.enignecapacityTextControllerValidator
                            .asValidator(context),
                        inputFormatters: [
                          FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                        ],
                        ...
                        onPressed: () async {
                          ...
                          await ordersRecordReference.set({
                            ...createOrdersRecordData(
                              ...
                              bodyColor: _model.bodycolorTextController.text,
                              requestState: false,
