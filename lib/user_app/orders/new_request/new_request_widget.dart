...
(до 10 штук) */
            ...
            TextFormField(
              ...
              validator:
                  _model.carmodelTextControllerValidator.asValidator(context),
            ),
            TextFormField(
              ...
              validator:
                  _model.caryearTextControllerValidator.asValidator(context),
              inputFormatters: [
            ...
            TextFormField(
              ...
              keyboardType: TextInputType.number,
              validator:
                  _model.mileageTextControllerValidator.asValidator(context),
            ),
            FlutterFlowDropDown<String>(
              controller: _model.enginetypeValueController ??=
                  FormFieldController<String>(
                _model.enginetypeValue ??= FFLocalizations.of(context).getText(
                  'praa0b7g' /* Бензин */,
                ),
              ),
              options: [
              ...
              onChanged: (val) => setState(() => _model.enginetypeValue = val),
              height: 56.0,
            ...
            TextFormField(
              ...
              validator:
                  _model.bodycolorTextControllerValidator.asValidator(context),
            ),
            FFButtonWidget(
              onPressed: () async {
                ...
                await ordersRecordReference.set({
                  ...createOrdersRecordData(
                    ...
                    mileage: int.tryParse(_model.mileageTextController.text),
                    carYear: int.tryParse(_model.caryearTextController.text),
